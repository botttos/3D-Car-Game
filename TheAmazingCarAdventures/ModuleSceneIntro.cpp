...
bool ModuleSceneIntro::Start()
{
	...
	Green_Cubes.add(c9);
	Map.add(App->physics->CreateWall(Uncolored_Cubes[App->physics->Cube_num], 10, 18, 1, actual_pos.x + 9, actual_pos.y, actual_pos.z - 70, NORTH, UNCOLORED)); //3rd road walls 3
	Cube c9_5;
