...
bool ModuleSceneIntro::Start()
{
	...
	App->physics->CreateWall(Uncolored_Cubes[App->physics->Cube_num], &Uncolored_Cubes_Bodies[App->physics->Cube_num], 4, 10, 1, actual_pos.x, actual_pos.y + 3, actual_pos.z - 13, WEST, UNCOLORED);	//receptor3
